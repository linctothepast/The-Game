...
def fighting_an_astroleer_sleep_question():
    repeat = True
    while repeat:
...
def fighting_an_astroleer_sleep_question_a():
    sleep = sleep.capitalize()
    if sleep == "A"
    fight = input("""You decide to sleep on a soft patch of
grass for the night, as you start to doze off, you hear a loud scream in the
nigher, instantly bolting you awake.
